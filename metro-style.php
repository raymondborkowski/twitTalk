...
<html>
	...
	<body>
		...
		<script>
			...
			var jsMedia = onlyMediaJack; //used
		...
		<div class="layout">
			<div id="freewall" class="free-wall">
				...
				<div class="size22 level1" data-nested=".size11" data-cellW=150 data-cellH=150 data-gutterX=10 >
					...
					<div class="item size11">RAY3</div>
				...
				<div class="item size22 level1">
					...
					<div id = "otherMedia3BottomText" class = "tempBottom">
						<!-- KSMEDIA!!!!-->
				...
				<div class="item size21 level1">
					<div id = "bigKate" class = "divCenterText">
						<script>displayMedia(ksText5.length, "bigKate", " ", ksText5, false);</script>
					</div>
				</div>

				<div class="item size22 level1">
					<div id = "otherMedia1IMG" class = "map">
					</div>
